...
public class SessionInterceptor implements HandlerInterceptor {
     ...
     * 过滤不校验session接口列表*
     */
    private String noCheck = "/js/.*|/css/.*|/image/.*|/style/.*|/login.jsp|/WEB-INF/.|error|.jsp|.txt|.html|.jpeg|.png|.gif|/uploadPic|/deletePic|/createOrder|/confirmOrder|/payCallBack|/queryGoodsPrice|/editAddress|/addAddress|/delAddress|/queryAddress|/confirmOrder|/createOrder|/queryOrder|/queryShop";
